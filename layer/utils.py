        ...
        try:
            ...
            try:
                ...
                indicator_obj = Indicators(
                    ...
                    slug = row.indicatorSlug.lower().strip() if row.indicatorSlug else None,
                    long_description = row.indicatorDescription.strip() if row.indicatorDescription else None,
                    # short_description = row.indicatorDescription if row.indicatorDescription else None,
                    category = row.indicatorCategory.strip() if row.indicatorCategory else None,
